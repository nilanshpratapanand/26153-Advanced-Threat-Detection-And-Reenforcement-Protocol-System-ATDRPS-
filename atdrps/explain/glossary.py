...
BASE_GLOSSARY: dict[str, str] = {
    ...
    "log_same_port_fanout": "hosts one source contacted on a single port (worm fan-out)",
    "half_open_ratio": "proportion of connections that never completed a handshake",
    "log_max_srcs_per_dst_service": "sources converging on one service",
    "dns_share": "share of traffic that is DNS",
    "log_dns_query_size": "size of DNS queries (long encoded subdomains mean tunnelling)",
    "ttl_inconsistency": "one source arriving with several different TTLs",
    "rst_injection_ratio": "resets injected into conversations already in flight",
    ...
    "fwd_ttl_mean": "TTL of packets from the initiating host",
